      ...
      <nav className="fixed bottom-0 w-full md:w-64 bg-background overflow-hidden md:h-full border-t md:border-r md:border-t-0 border-gray px-1 md:p-2.5">
        ...
        <div className="justify-between justify-items-stretch w-full flex flex-row md:flex-col md:py-4 gap-2">
          ...
          <NavLink to="/create-post" className={ ({ isActive }) => isActive ? linkStyles.active : linkStyles.nonactive }>
            <span className="inline-flex items-center justify-center h-12 w-12 text-2xl md:text-xl text-foreground"><i class="bx bx-add-to-queue"></i></span>          
            <span className="hidden md:block">Create</span>
          </NavLink>
          <NavLink to="/something" className={ ({ isActive }) => isActive ? linkStyles.active : linkStyles.nonactive }>
            <span className="inline-flex items-center justify-center h-12 w-12 text-2xl md:text-xl text-foreground"><i class="bx bx-bell"></i></span>
            <span className="hidden md:block">Notifications</span>
          </NavLink>
          <NavLink to="/profile" className={ ({ isActive }) => isActive ? linkStyles.active : linkStyles.nonactive }>
            <span className="inline-flex items-center justify-center h-12 w-12 text-2xl md:text-xl text-foreground"><i class="bx bx-user"></i></span>
          ...
          <Link onClick={signOut} className="flex items-center justify-center md:justify-normal w-full py-1 md:py-0 md:rounded-lg hover:bg-lightgray ease duration-150 active:scale-95">
            <span className="inline-flex items-center justify-center h-12 w-12 text-2xl md:text-xl text-foreground"><i class="bx bx-log-out"></i></span>
